            ...
            <nav className="bg-white border-b border-gray-100">
                                ...
                                <div className="hidden sm:flex sm:items-center sm:ml-6">
                                    <div className="relative">
                                        <Dropdown>
                                            ...
                                            <Dropdown.Content>
                                                <Dropdown.Link href={route('my-exercises.index')} className='text-xl'>Workout Log</Dropdown.Link>
                                ...
                                <div className="hidden sm:flex sm:items-center sm:ml-6">
                                    <div className="relative">
                                        <Dropdown>
                                            ...
                                            <Dropdown.Content>
                                                <Dropdown.Link href={route('calculators.index')} className='text-xl'>BMI</Dropdown.Link>
                                            </Dropdown.Content>
                                        </Dropdown>
                                    </div>
                                </div>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('my-exercises.index')} active={route().current('exercises.*')}>
                            Workout Log
                        </ResponsiveNavLink>
                        ...
                        <ResponsiveNavLink href={route('calculators.index')} active={route().current('calculators.*')}>
                            Calculators
                        </ResponsiveNavLink>
                    </div>
